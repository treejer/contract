...
contract("O2Factory", (accounts) => {
  ...
  //     unsafeAllowCustomTypes: true,
  //   });
  //   o2Instance = await deployProxy(O2Factory, [arInstance.address], {
  //     initializer: "initialize",
  //     from: deployerAccount,
  //   });
  ...
  //     unsafeAllowCustomTypes: true,
  //   });
  //   o2TokenInstance = await deployProxy(O2, [arInstance.address], {
  //     initializer: "initialize",
  //     from: deployerAccount,
  //     unsafeAllowCustomTypes: true,
  //   });
  ...
  //     from: deployerAccount,
  //   });
  //   await o2Instance.setTreeTypeAddress(treeTypeInstance.address, {
  //     from: deployerAccount,
  //   });
  //   await o2Instance.setTreeFactoryAddress(treeInstance.address, {
  //     from: deployerAccount,
  //   });
  //   await o2Instance.setUpdateFactoryAddress(updateInstance.address, {
  //     from: deployerAccount,
  //   });
  //   await o2Instance.setTreeTokenAddress(treeTokenInstance.address, {
  //     from: deployerAccount,
  //   });
  //   await o2Instance.setO2TokenAddress(o2TokenInstance.address, {
  //     from: deployerAccount,
  //   });
  ...
  //     return (
  //       ev.owner.toString() === planter1Account &&
  //       "400" >= ev.totalO2.toString() <= "500"
  //     );
  //   });
  // });
  ...
  //   await addTree();
  //   await o2Instance.mint({ from: planter1Account });
  //   return await o2TokenInstance
  //     .balanceOf(planter1Account, { from: planter1Account })
  //     .then((balance) => {
  //       assert.equal("200", balance, "Balance of planter: " + balance);
  //     })
  //     .catch((error) => {
  //       console.log(error);
  //     });
